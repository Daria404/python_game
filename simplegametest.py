...
start_button = Button(GREEN, 180, 132, 140, 50, True, 'START')
exit_button  = Button(RED, 180, 254, 140, 50, True, 'EXIT')
...
while 1:
    ...
    for event in pygame.event.get():
        ...
        if box_button.pic_isPressed(event):
            BOX = not BOX
            TRY_TO_BUY = False
            buy_button.active = not buy_button.active
