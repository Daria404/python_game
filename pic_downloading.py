...
LAST_LIFE_pic = add_image('1heart.png')
LIFEx2_pic = add_image('2hearts.png')
FULL_LIFE_pic = add_image('3hearts.png')
...
SETTINGS_BUTTON_PIC = add_image('settings.png')
HELP_BUTTON_PIC = add_image('help.png')
HELP_WINDOW_PIC = add_image('help_window.png')
